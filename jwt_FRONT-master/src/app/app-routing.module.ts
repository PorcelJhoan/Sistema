...
import { VentaProductoComponent } from './producto/venta-producto/venta-producto.component';
...
const routes: Routes = [
  ...
  { path: 'venta', component:VentaProductoComponent , canActivate: [guard], data: { expectedRol: ['admin', 'user']} },
