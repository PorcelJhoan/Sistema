...
export class ProductoService {
  ...
  public lista(page:number,size:number,order:string,asc:boolean  ): Observable<Producto[]> {
    return this.httpClient.get<Producto[]>(this.productoURL + `lista?page=${page}&size=${size}&order=${order}&asc=${asc}`);
  }
